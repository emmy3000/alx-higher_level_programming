...
/**
	* print_hexn: prints hexidecimal of first n bytes
	* of a given string
	*
	* print_python_bytes: bytes object info and first
	* 10 bytes of its content in hex format
	*
	* print_python_list: prints info on Python lisy
	* object and tyoe of content of each element in a
	* list
	*
	*/
